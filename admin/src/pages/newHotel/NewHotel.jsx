...
const handleClick =async (e)=>{
  ...
  try {
    const list = await Promise.all(Object.values(files).map(async (file)=>{
      ...
      const uploadRes= await axios.post("https://api.cloudinary.com/v1_1/dm7a4sfqq/image/upload", data)
            ...
            <form>
              ...
              <div className="formInput" >
                ...
                <div className="formInput" >
                  ...
                  <select name="rooms" className="selectedRooms" multiple onChange={handleSelect}> 
                    {!loading && data && data.result.map((room) => (
